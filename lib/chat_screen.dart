...
class ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    id = globals.mainUser.id;
    print('myId'+id.toString());
    print('peerId'+peerId.toString());
    groupChatId = peerId+id;
    print('id is'+groupChatId.toString());
  ...
  Future getImage() async {
    ...
    PickedFile pickedFile = await imagePicker.getImage(source: ImageSource.gallery,imageQuality: 50);
